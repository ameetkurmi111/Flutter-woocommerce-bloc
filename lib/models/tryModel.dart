...
class TryModel extends ChangeNotifier {
  ...
  List<ItemCountModel> il;

  static List<BasketModel> basketData = [];
  //int countBadge=0;

  //PostCode postData =
  List<PostCode> pstCod = [PostCode(1, "14770", 10.0)];

  int b;
  ItemCountModel itemContMdl;
  ...
  addBasketData(
    ...
    basketModel = BasketModel(itemIndexCount, productName, price, productId,
        taxClass, description, choice, pageWhich);
